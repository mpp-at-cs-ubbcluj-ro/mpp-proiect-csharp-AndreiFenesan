...
partial class MainForm
{
    ...
    private BindingList<Donor> _donors;
    ...
    private void initViews()
    {
        ...
        this._donors = new BindingList<Donor>();
    }

    private void updateCharityCases()
    {
    ...
    private void updateDonorsView(IEnumerator<Donor> donors)
    {
        this._donors.Clear();
